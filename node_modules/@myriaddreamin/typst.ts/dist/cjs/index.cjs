...
__export(stdin_exports, {
  ...
  createTypstFontBuilder: () => import_compiler.createTypstFontBuilder,
  createTypstRenderer: () => import_renderer.createTypstRenderer,
  initOptions: () => initOptions_1,
  loadFonts: () => import_options_init.loadFonts,
...
var initOptions_1 = __toESM(require("./options.init.cjs"));
...
var import_snippet = require("./contrib/snippet.cjs");
