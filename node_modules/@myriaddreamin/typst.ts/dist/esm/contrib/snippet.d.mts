...
import { type BeforeBuildFn, type InitOptions, LoadRemoteAssetsOptions } from '../options.init.mjs';
import type { TypstRenderer } from '../renderer.mjs';
import type { RenderToCanvasOptions, RenderSvgOptions } from '../options.render.mjs';
import { type WritableAccessModel } from '../fs/index.mjs';
import { PackageRegistry, PackageSpec, SemanticTokens, SemanticTokensLegend } from '../internal.types.mjs';
/**
...
export declare class TypstSnippet {
     ...
     */
    getRenderer(): Promise<TypstRenderer>;
    private providers?;
    /**
     ...
     */
    setFonts(fontInfos: SweetLazyFont[]): Promise<void>;
    /**
